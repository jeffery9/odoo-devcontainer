...
class UpdateQuery(Query):
    ...
    where: WhereNode = ...
    def update_batch(
        self, pk_list: list[int], values: dict[str, int | None], using: str
    ) -> None: ...
    def add_update_values(self, values: dict[str, Any]) -> None: ...
    def add_update_fields(
        self, values_seq: list[tuple[Field[Any, Any], type[Model] | None, Case]]
    ) -> None: ...
    def add_related_update(
        self, model: type[Model], field: Field[Any, Any], value: int | str
    ) -> None: ...
