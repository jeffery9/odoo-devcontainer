...
class _ThetaShift(ScaledTranslation):
    def __init__(self, axes: Axes, pad: float, mode: Literal["min", "max", "rlabel"]) -> None: ...
    def get_matrix(self) -> np.ndarray | None: ...
...
class RadialAxis(Axis):
    axis_name: str = ...
    _tick_class: Type[RadialTick] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def clear(self) -> None: ...

class _WedgeBbox(Bbox):
    def __init__(self, center: Sequence[float], viewLim: Bbox, originLim: Bbox, **kwargs) -> None: ...
...
class PolarAxes(Axes):
    ...
    def set_thetagrids(
        self, angles: tuple[float, ...], labels: tuple[str, ...] | None = ..., fmt: str | None = ..., **kwargs
    ) -> tuple[list[Line2D], list[Text]]: ...
    def set_rgrids(
        self, radii: tuple[float, ...], labels: None | tuple[str, ...] = ..., angle: float = ..., fmt: str | None = ..., **kwargs
    ) -> tuple[list[Line2D], list[Text]]: ...
