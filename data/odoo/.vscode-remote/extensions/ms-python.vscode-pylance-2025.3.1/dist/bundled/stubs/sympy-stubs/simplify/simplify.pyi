...
) -> dict[str, Any] | dict[Any, list[Any]] | Order | Abs | type[UndefinedFunction] | Any | None: ...
...
def clear_coefficients(
    expr, rhs=...
) -> tuple[Any, Any] | tuple[Any | Expr | Relational | Order | Eq | Ne | Add | tuple[Any, dict[Any, Any]], Any]: ...
