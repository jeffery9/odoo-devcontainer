...
def check_classifiers_train(name, classifier_orig, readonly_memmap: bool = False, X_dtype: str = "float64"): ...
...
def check_estimators_fit_returns_self(name, estimator_orig, readonly_memmap: bool = False): ...
def check_estimators_unfitted(name, estimator_orig): ...
def check_supervised_y_2d(name, estimator_orig): ...
def check_classifiers_predictions(X, y, name, classifier_orig): ...
def check_classifiers_classes(name, classifier_orig): ...
def check_regressors_int(name, regressor_orig): ...
def check_regressors_train(name, regressor_orig, readonly_memmap: bool = False, X_dtype=...): ...
