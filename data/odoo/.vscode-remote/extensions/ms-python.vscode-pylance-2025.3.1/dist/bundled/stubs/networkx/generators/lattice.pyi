...
def triangular_lattice_graph(m: int, n: int, periodic=False, with_positions=True, create_using=None): ...
def hexagonal_lattice_graph(m: int, n: int, periodic: bool = False, with_positions=True, create_using=None): ...
