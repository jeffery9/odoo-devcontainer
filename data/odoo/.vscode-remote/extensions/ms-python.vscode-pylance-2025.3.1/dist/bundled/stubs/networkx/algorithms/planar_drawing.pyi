...
def combinatorial_embedding_to_pos(embedding, fully_triangulate: bool = False) -> Mapping: ...
...
def make_bi_connected(embedding, starting_node, outgoing_node, edges_counted: set) -> ArrayLike: ...
