...
class NamespaceMagics(Magics):
    ...
    @line_magic
    def psearch(self, parameter_s=...): # -> None:
    ...
    @skip_doctest
    @line_magic
    def whos(self, parameter_s=...): # -> None:
    ...
    @line_magic
    def reset(self, parameter_s=...): # -> None:
    ...
    @line_magic
    def reset_selective(self, parameter_s=...): # -> None:
    ...
    @line_magic
    def xdel(self, parameter_s=...): # -> None:
