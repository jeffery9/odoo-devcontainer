...
def integer_nthroot(
    y, n
) -> tuple[int, bool] | tuple[Any, Literal[True]] | tuple[Literal[1], Literal[False]] | tuple[int, Any]: ...
...
class Pow(Expr):
    ...
    def as_numer_denom(
        self,
    ) -> tuple[Self, Any] | tuple[Any | Mul | Expr, Self] | tuple[Self, Any | Mul | Expr] | tuple[Self, Self]: ...
