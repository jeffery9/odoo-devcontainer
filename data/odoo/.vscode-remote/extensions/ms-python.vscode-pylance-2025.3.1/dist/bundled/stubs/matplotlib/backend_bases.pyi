...
class GraphicsContextBase:
    ...
    def set_sketch_params(self, scale: float = ..., length: float = ..., randomness: float = ...) -> None: ...

class TimerBase:
    def __init__(self, interval: int = 1000, callbacks: list[tuple[Callable, tuple, dict]] = ...) -> None: ...
...
class LocationEvent(Event):
    ...
    lastevent = ...
    def __init__(self, name: str, canvas: FigureCanvasBase, x: int, y: int, guiEvent=...) -> None: ...
...
class PickEvent(Event):
    ...
    def __init__(
        self, name: str, canvas: FigureCanvasBase, mouseevent: MouseEvent, artist: Artist, guiEvent=..., **kwargs
    ) -> None: ...
...
class FigureCanvasBase:
    ...
    def button_press_event(self, x: float, y: float, button, dblclick: bool = ..., guiEvent=...) -> None: ...
...
def key_press_handler(event: KeyEvent, canvas: FigureCanvasBase = ..., toolbar: NavigationToolbar2 = ...) -> None: ...
