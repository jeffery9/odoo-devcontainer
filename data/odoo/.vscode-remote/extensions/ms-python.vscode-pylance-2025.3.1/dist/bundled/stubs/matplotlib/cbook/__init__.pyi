...
class CallbackRegistry:
    def __init__(self, exception_handler: Callable = ..., *, signals: list = ...) -> None: ...
...
@overload
def get_sample_data(fname, asfileobj: bool = ..., *, np_load: bool = ...) -> ArrayLike | tuple | dict: ...
@overload
...
def violin_stats(X: ArrayLike, method: Callable, points: int = ..., quantiles: ArrayLike = ...) -> list[dict]: ...
