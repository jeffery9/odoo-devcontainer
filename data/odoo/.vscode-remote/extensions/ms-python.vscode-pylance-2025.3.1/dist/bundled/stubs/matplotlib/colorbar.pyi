...
class Colorbar:
    ...
    def set_ticks(
        self, ticks: list[float], update_ticks: bool = True, labels: list[str] | None = None, *, minor: bool = False, **kwargs
    ) -> None: ...
    def get_ticks(self, minor: bool = False) -> list: ...
    def set_ticklabels(self, ticklabels: Text, update_ticks: bool = True, *, minor: bool = False, **kwargs) -> None: ...
