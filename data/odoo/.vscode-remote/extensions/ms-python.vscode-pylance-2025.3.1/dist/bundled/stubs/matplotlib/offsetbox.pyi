...
class PackerBase(OffsetBox):
    def __init__(
        ...
        width: float = ...,
        height: float = ...,
        align: Literal["top", "bottom", "left", "right", "center", "baseline"] = "baseline",
...
class TextArea(OffsetBox):
    def __init__(self, s: str, textprops: dict = ..., multilinebaseline: bool = False) -> None: ...
...
class AnchoredText(AnchoredOffsetbox):
    ...
    def __init__(self, s: str, loc: str, pad: float = ..., borderpad: float = ..., prop: dict = ..., **kwargs) -> None: ...
