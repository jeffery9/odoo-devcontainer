...
class EngFormatter(Formatter):
    ENG_PREFIXES = ...
    def __init__(
        self, unit: str = "", places: int | None = None, sep: str = " ", *, usetex: bool = ..., useMathText: bool = ...
    ) -> None: ...
...
def scale_range(vmin: float, vmax: float, n: int = ..., threshold: int = ...) -> tuple[float, int]: ...
...
class LogitLocator(MaxNLocator):
    def __init__(self, minor: bool = ..., *, nbins: int | Literal["auto"] = ...) -> None: ...
