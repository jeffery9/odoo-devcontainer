...
class CoordSys3D(Basic):
    def __new__(
        cls, name, transformation=..., parent=..., location=..., rotation_matrix=..., vector_names=..., variable_names=...
    ): ...
    def __iter__(self): ...
    @property
    def origin(self): ...
    ...
    def orient_new_body(
        self, name, angle1, angle2, angle3, rotation_order, location=..., vector_names=..., variable_names=...
    ) -> CoordSys3D: ...
