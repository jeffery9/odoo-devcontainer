...
class BaseSpatialFeatures:
    ...
    @property
    def supports_bbcontains_lookup(self) -> Any: ...
    @property
    def supports_contained_lookup(self) -> Any: ...
    @property
    def supports_crosses_lookup(self) -> Any: ...
    @property
    def supports_distances_lookups(self) -> Any: ...
    @property
    def supports_dwithin_lookup(self) -> Any: ...
    @property
    def supports_relate_lookup(self) -> Any: ...
    @property
    def supports_isvalid_lookup(self) -> Any: ...
    @property
    def supports_collect_aggr(self) -> Any: ...
    @property
    def supports_extent_aggr(self) -> Any: ...
    @property
    def supports_make_line_aggr(self) -> Any: ...
    @property
    def supports_union_aggr(self) -> Any: ...
