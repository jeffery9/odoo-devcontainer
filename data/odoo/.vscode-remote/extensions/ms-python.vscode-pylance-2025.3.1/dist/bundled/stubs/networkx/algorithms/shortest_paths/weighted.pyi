...
def single_source_dijkstra_path(G: Graph, source, cutoff=None, weight="weight") -> Mapping: ...
def single_source_dijkstra_path_length(G: Graph, source, cutoff=None, weight="weight") -> Mapping: ...
def single_source_dijkstra(G: Graph, source, target=None, cutoff=None, weight="weight"): ...
def multi_source_dijkstra_path(G: Graph, sources, cutoff=None, weight="weight") -> Mapping: ...
def multi_source_dijkstra_path_length(G: Graph, sources, cutoff=None, weight="weight") -> Mapping: ...
def multi_source_dijkstra(G: Graph, sources, target=None, cutoff=None, weight="weight"): ...
def dijkstra_predecessor_and_distance(G: Graph, source, cutoff=None, weight="weight") -> dict: ...
...
def bellman_ford_predecessor_and_distance(G: Graph, source, target=None, weight="weight", heuristic: bool = False) -> dict: ...
