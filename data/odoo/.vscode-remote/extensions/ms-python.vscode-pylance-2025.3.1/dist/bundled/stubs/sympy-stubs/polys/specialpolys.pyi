...
def dmp_fateman_poly_F_1(
    n, K
) -> tuple[Any | list[Any] | list[list[Any]], Any | list[Any] | list[list[Any]], list[list[Any]] | Any | list[Any]]: ...
def fateman_poly_F_2(n) -> tuple[Any, Any, Any]: ...
def dmp_fateman_poly_F_2(
    n, K
) -> tuple[Any | list[Any] | list[list[Any]], Any | list[Any] | list[list[Any]], Any | list[list[Any]]]: ...
