...
class _AxesBase(Artist):
    ...
    def set_axes_locator(self, locator: Callable[[Axes, RendererBase], Bbox]) -> None: ...
    ...
    def set_adjustable(self, adjustable: Literal["box", "datalim"], share: bool = False) -> None: ...
    ...
    def margins(self, *margins, x: float = ..., y: float = ..., tight: bool | None = True) -> tuple[float, float]: ...
    ...
    def autoscale_view(self, tight: bool | None = ..., scalex: bool = True, scaley: bool = True) -> None: ...
    @allow_rasterization
    ...
    def set_xlabel(
        self, xlabel: str, fontdict=..., labelpad: float = ..., *, loc: Literal["left", "center", "right"] = ..., **kwargs
    ) -> None: ...
    ...
    def set_xscale(self, value: Literal["linear", "log", "symlog", "logit"] | ScaleBase, **kwargs) -> None: ...
    get_xticks = ...
    set_xticks = ...
    ...
    def set_ylabel(
        self, ylabel: str, fontdict=..., labelpad: float = ..., *, loc: Literal["bottom", "center", "top"] = ..., **kwargs
    ) -> None: ...
    ...
    get_yscale = ...
    def set_yscale(self, value: Literal["linear", "log", "symlog", "logit"] | ScaleBase, **kwargs) -> None: ...
    get_yticks = ...
    set_yticks = ...
