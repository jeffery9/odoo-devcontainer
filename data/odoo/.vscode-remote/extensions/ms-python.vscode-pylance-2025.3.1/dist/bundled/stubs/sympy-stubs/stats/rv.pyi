...
def expectation(
    expr, condition=..., numsamples=..., evaluate=..., **kwargs
) -> (
    Basic
    | Expectation
    | tuple[Any, ...]
...
def probability(
    condition, given_condition=..., numsamples=..., evaluate=..., **kwargs
...
def density(
    expr, condition=..., evaluate=..., numsamples=..., **kwargs
) -> dict[Any, Any] | Density | Lambda | Basic | Any | FiniteDensity | None: ...
...
def sample(
    expr, condition=..., size=..., library=..., numsamples=..., seed=..., **kwargs
) -> list[Any | JointRandomSymbol | Basic] | JointRandomSymbol | Basic: ...
def quantile(expr, evaluate=..., **kwargs) -> Lambda | Any: ...
def sample_iter(
    expr, condition=..., size=..., library=..., numsamples=..., seed=..., **kwargs
) -> Generator[Any, Any, None] | Generator[Any | JointRandomSymbol | Basic, Any, None]: ...
def sample_iter_lambdify(
    expr, condition=..., size=..., numsamples=..., seed=..., **kwargs
) -> Generator[Any, Any, None] | Generator[Any | JointRandomSymbol | Basic, Any, None]: ...
def sample_iter_subs(
    expr, condition=..., size=..., numsamples=..., seed=..., **kwargs
) -> Generator[Any, Any, None] | Generator[Any | JointRandomSymbol | Basic, Any, None]: ...
